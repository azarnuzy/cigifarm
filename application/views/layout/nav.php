    ...
    <nav class="limiter-menu-desktop container">
        ...
        <div class="menu-desktop">
            <ul class="main-menu">
                ...
                <li>
                    <!-- class="active-menu" -->
                    <a href="<?php echo base_url('acara') ?>">Acara</a>
                </li>
        ...
        <div class="wrap-icon-header flex-w flex-r-m">
            ...
            <!-- Notif Belum Bayar -->
            <a href="<?php echo base_url('dasbor/belanja') ?>"
                class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 <?php if(count($nav_header_belum)>0){echo "icon-header-noti";} ?>"
                data-notify="<?php echo count($nav_header_belum) ?>">
                <i class="zmdi zmdi-notifications-active"></i>
            </a>

            <!-- Jika Belum login mengarah ke registrasi -->
            <?php } else { ?>
            <a style="font-size: 18pt" class="cl2 hov-cl1 trans-04 p-l-22 p-r-11"
                href="<?php echo base_url('registrasi') ?>"><i class="fa fa-user-o"></i>
            </a>
            <?php } ?>
            ...
            <div class="icon-header-item cl2 hov-cl1 trans-04 p-l-22 p-r-11 icon-header-noti js-show-cart"
                data-notify="<?php echo count($keranjang) ?>">
...
<div class="wrap-header-mobile">
    ...
    <div class="logo-mobile">
        <a href="<?php echo base_url() ?>"><img src="<?php echo base_url('assets/upload/image/'.$site->logo) ?>"
                alt="<?php echo $site->namaweb ?> | <?php echo $site->tagline ?>"></a>
    </div>
    ...
    <div class="wrap-icon-header flex-w flex-r-m m-r-15">
        ...
        <?php } else { ?>
        <a style="font-size: 18pt" class="cl2 hov-cl1 trans-04 p-l-22 p-r-11"
            href="<?php echo base_url('registrasi') ?>">
        ...
        <div class="icon-header-item cl2 hov-cl1 trans-04 p-l-18 p-r-11 icon-header-noti js-show-cart"
            data-notify="<?php echo count($keranjang) ?>">
            <i class="zmdi zmdi-shopping-cart"></i>
        </div>
