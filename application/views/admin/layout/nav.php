  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      <ul class="sidebar-menu" data-widget="tree">
        <!-- MENU DASBOR -->
        <li><a href="<?php echo base_url('admin/dasbor') ?>"><i class="fa fa-dashboard text-white"></i> <span>Dashboard</span></a></li>
        ...
        <!-- MENU REKENING -->
        <li><a href="<?php echo base_url('admin/rekening') ?>"><i class="fa fa-dollar text-white"></i> <span>Data Rekening</span></a></li>

        <!-- MENU USER -->
        <li><a href="<?php echo base_url('admin/user') ?>"><i class="fa fa-lock text-white"></i> <span>Data Pengguna</span></a></li>
        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo base_url('admin/konfigurasi') ?>"><i class="fa fa-home"></i> Konfigurasi Website</a></li>
