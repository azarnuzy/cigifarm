	...
	<tbody>
		...
		<tr>
			...
			<td class="text-center">
				<a href="<?php echo base_url('admin/transaksi/cetak/'.$header_transaksi->kode_transaksi) ?>" target="_blank" class="btn btn-success btn-xs"><i class="fa fa-file-pdf-o"></i> Cetak Transaksi</a><br></br>
				<a href="<?php echo base_url('admin/transaksi/cetak_kirim/'.$header_transaksi->kode_transaksi) ?>" target="_blank" class="btn btn-warning btn-xs"><i class="fa fa-print"></i> Cetak Pengiriman</a> <br></br>
